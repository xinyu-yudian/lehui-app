...
<!-- 								<image
									...
									mode=""
								></image> -->
								<u-icon name="star-fill" class="tool-img" color="#464958" size="45"></u-icon>
							...
							<view class="tools-item u-flex-col u-row-center u-col-center" @tap="goCart">
								<!-- <image class="tool-img" :src="$IMG_URL + '/imgs/share/share.png'" mode=""></image> -->
								<u-icon name="shopping-cart-fill" class="tool-img" color="#464958" size="45"></u-icon>
								<text class="tool-title">购物车</text>
							</view>
						</block>
					</view>
					<!-- foot右侧 -->
					<view class="detail-right">
						...
						<view v-if="detailType !== 'score'">
							...
							<view class="detail-btn-box u-flex u-row-around" v-if="!goodsInfo.activity_type">
								<button class=" u-reset-button tool-btn add-btn add-goods-cart" @tap="addCart">加入购物车</button>
