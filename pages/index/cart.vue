...
<script>
	...
	import shHotGoods from './components/sh-recommended-goods.vue';
	let timer = null;
	export default {
		components: {
			shHotGoods
		...
		computed: {
			...mapGetters(['homeTemplate','totalCount', 'isSel', 'isActivityPay', 'cartList', 'allSelected', 'authType', 'isLogin']),
			isEmpty() {
