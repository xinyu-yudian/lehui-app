...
<template>
	<view class="order-detail-wrap">
		...
		<view class="order-price-box u-m-b-20" v-if="orderDetail.id">
			...
			<view class="notice-item u-flex u-row-between" v-if="orderDetail.is_cook == 1">
				<text class="title">厨师服务费</text>
				<text class="detail font-OPPOSANS">￥{{ orderDetail.cook_service_amount }}</text>
			</view>
			<view class="notice-item u-flex u-row-between">
