...
export default {
	...
	money: {
		...
		getrechargerule: {
			url: "user_wallet_log/getrechargerule",
			auth: true,
			method: "GET",
			// desc: '获取充值赠送'
		}
	...
	lottery: {
		needJoin: {
			url: "lottery/need_join",
			auth: false,
			method: "GET",
			// desc: '分销身份鉴权',
		},
		needJoinNologin: {
			url: "lottery/need_join_nologin",
			auth: false,
			method: "GET",
			// desc: '分销身份鉴权',
		},
		lotteryList: {
			url: "lottery/lottery_list",
			auth: false,
			method: "GET",
			// desc: '分销身份鉴权',
		},
		...
		lotteryDetail: {
			url: "lottery/lottery_detail",
			auth: false,
			method: "GET",
			// desc: '分销身份鉴权',
		},
		joinLottery: {
			url: "lottery/join_lottery",
			auth: false,
			method: "GET",
			// desc: '分销身份鉴权',
		},
		awardlist: {
			url: "lottery/award_list",
			auth: false,
			method: "GET",
			// desc: '分销身份鉴权',
		},
